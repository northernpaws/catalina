...
use super::pitch::{HasPitch, Pitch};
...
mod tests {
    ...
    #[test]
    fn test_properties() {
        self::assert_eq!(NamedPitch::A.named_pitch(), NamedPitch::A);
    }

    #[test]
    fn test_pitch_conversion() {
        self::assert_eq!(NamedPitch::from(Pitch::C), NamedPitch::C);
        self::assert_eq!(NamedPitch::from(&Pitch::C), NamedPitch::C);
        self::assert_eq!(NamedPitch::from(Pitch::DFlat), NamedPitch::DFlat);
        self::assert_eq!(NamedPitch::from(&Pitch::DFlat), NamedPitch::DFlat);
        self::assert_eq!(NamedPitch::from(Pitch::D), NamedPitch::D);
        self::assert_eq!(NamedPitch::from(&Pitch::D), NamedPitch::D);
        self::assert_eq!(NamedPitch::from(Pitch::EFlat), NamedPitch::EFlat);
        self::assert_eq!(NamedPitch::from(&Pitch::EFlat), NamedPitch::EFlat);
        self::assert_eq!(NamedPitch::from(Pitch::E), NamedPitch::E);
        self::assert_eq!(NamedPitch::from(&Pitch::E), NamedPitch::E);
        self::assert_eq!(NamedPitch::from(Pitch::F), NamedPitch::F);
        self::assert_eq!(NamedPitch::from(&Pitch::F), NamedPitch::F);
        self::assert_eq!(NamedPitch::from(Pitch::GFlat), NamedPitch::GFlat);
        self::assert_eq!(NamedPitch::from(&Pitch::GFlat), NamedPitch::GFlat);
        self::assert_eq!(NamedPitch::from(Pitch::G), NamedPitch::G);
        self::assert_eq!(NamedPitch::from(&Pitch::G), NamedPitch::G);
        self::assert_eq!(NamedPitch::from(Pitch::AFlat), NamedPitch::AFlat);
        self::assert_eq!(NamedPitch::from(&Pitch::AFlat), NamedPitch::AFlat);
        self::assert_eq!(NamedPitch::from(Pitch::A), NamedPitch::A);
        self::assert_eq!(NamedPitch::from(&Pitch::A), NamedPitch::A);
        self::assert_eq!(NamedPitch::from(Pitch::BFlat), NamedPitch::BFlat);
        self::assert_eq!(NamedPitch::from(&Pitch::BFlat), NamedPitch::BFlat);
