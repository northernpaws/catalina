...
pub trait Frame: Copy + Clone + PartialEq {
    ...
    ///
    /// ```rust
    /// use catalina_engine::audio::{Frame, Mono, Stereo};
    ///
    /// fn main() {
    ...
    ///
    /// ```rust
    /// use catalina_engine::audio::Frame;
    ///
    /// fn main() {
...
impl_frame_for_sample! {
    crate::audio::sample::types::I24
    crate::audio::sample::types::I48
    crate::audio::sample::types::U24
    crate::audio::sample::types::U48
}
